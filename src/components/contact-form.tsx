...
import { contactsApi, clientsApi, dealsApi, type Contact, type CreateContactInput, type Client, type Deal } from "@/lib/api";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dataToSend: CreateContactInput = {
        ...
        prefix: formData.prefix || (contact ? null : undefined),
        last_name: formData.last_name || (contact ? null : undefined),
        title: formData.title || (contact ? null : undefined),
        email: formData.email || (contact ? null : undefined),
        phone: formData.phone || (contact ? null : undefined),
        country: formData.country || (contact ? null : undefined),
        linkedin_url: formData.linkedin_url || (contact ? null : undefined),
        instagram: formData.instagram || (contact ? null : undefined),
        timezone: formData.timezone || (contact ? null : undefined),
        birthday: formData.birthday || (contact ? null : undefined),
        anniversary_date: formData.anniversary_date || (contact ? null : undefined),
