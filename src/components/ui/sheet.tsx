...
function Sheet({
  ...
  return (
    <SheetContainerContext.Provider value={container ?? null}>
  ...
  return (
    <SheetPortal container={container ?? undefined}>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 flex flex-col gap-4 shadow-lg transition ease-in-out",
          positionClass,
          "z-50",
          side === "right" &&
